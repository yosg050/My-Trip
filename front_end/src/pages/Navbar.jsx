...
//   let userProfileData, loading, error;
//   try {
//     ({ userData: userProfileData, error } = useUserProfile());
//   } catch (e) {
//     console.error("Error in useUserProfile:", e);
//   }
//   useEffect(() => {
...
//         </div>
//       </Navbar>
//       <div style={{ height: "5px", backgroundColor: "#e0e0e0" }}></div>
